...
export const CARDS: CardDef[] = [
  ...
  { id: "lanet", name: "Lanet", emoji: "🖤", rarity: "epic", hp: 1, dmg: 0, cd: 1.0, range: "uzak", description: "Yetenek: Bedava. Tek kullanımlıktır, kullanınca yok olur. Tüm rakipleri 4.4 saniyeliğine dondurur (hareket edemez ve vuramazlar).", ability: "Tüm rakipleri 4.4 saniyeliğine dondurur (Kendini yok eder)", stoneCost: 5 }
];
