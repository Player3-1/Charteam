...
export const CARDS: CardDef[] = [
  { id: "mizrakli", name: "Mızraklı", emoji: "🔱", rarity: "common", hp: 120, dmg: 60, cd: 0.7, range: "yakın", description: "Hızlı yakın menzil birliği." },
  { id: "kilicli", name: "Kılıçlı", emoji: "⚔️", rarity: "common", hp: 160, dmg: 75, cd: 1.5, range: "yakın", description: "Yavaş ama sert vuruşlu kılıç ustası." },
  { id: "dev", name: "Dev", emoji: "🗿", rarity: "common", hp: 450, dmg: 30, cd: 1.8, range: "yakın", description: "Tankı yüksek, ön cephe birliği." },
  { id: "atli", name: "Atlı", emoji: "🐎", rarity: "rare", hp: 130, dmg: "25 / 75", cd: 1.2, range: "yakın", description: "Hızla çarparsa 75 hasar, yavaşken 25." },
  { id: "okcu", name: "Okçu", emoji: "🏹", rarity: "common", hp: 65, dmg: 20, cd: 0.5, range: "uzak", description: "Uzak menzilden hızlı oklar atar." },
  { id: "tufekci", name: "Tüfekçi", emoji: "🔫", rarity: "rare", hp: 105, dmg: 50, cd: 1.3, range: "uzak", description: "Sert ateşli, yavaş tetik." },
  ...
  { id: "topcu", name: "Topçu", emoji: "💣", rarity: "rare", hp: 90, dmg: 60, cd: 2.5, range: "uzak", description: "Yıkıcı geniş alan hasarlı top ateşi." },
  { id: "ejder", name: "Ejder", emoji: "🐉", rarity: "epic", hp: 110, dmg: 40, cd: 1.4, range: "hava", description: "Havadan alev nefesi ile alan hasarı verir." },
  { id: "kus-ordusu", name: "Kuş Ordusu", emoji: "🐦", rarity: "epic", hp: 20, dmg: 5, cd: 1.0, range: "hava", description: "5 hızlı kuş, gözden kaçırma." },
  ...
  { id: "madenci", name: "Madenci", emoji: "⛏️", rarity: "legendary", hp: 130, dmg: 30, cd: 0.9, range: "yakın", description: "İstenen yere kazıp çıkar.", ability: "Konum seç ve çık" },
  { id: "doktor", name: "Doktor", emoji: "⚕️", rarity: "legendary", hp: 90, dmg: 0, cd: 0, range: "yakın", description: "Müttefiklere +60 can verir, canı azalan müttefikleri takip eder.", ability: "5 saniye CD ile 5x5 iyileştirme" },
  { id: "bira-varili", name: "Bira Varili", emoji: "🍺", rarity: "legendary", hp: 1, dmg: 0, cd: 0, range: "yakın", description: "Müttefik hasarı 2.0x. 30sn dayanır.", ability: "10sn 3.0x hasar" },
  ...
  { id: "buz-dolabi", name: "Buz Sapanı", emoji: "🧊", rarity: "rare", hp: 85, dmg: 25, cd: 2.0, range: "uzak", description: "2sn'de bir buz atar, kartı 1.5s mavi yapıp dondurur." },
  { id: "kardan-adam", name: "Kardan Adam", emoji: "⛄", rarity: "epic", hp: 100, dmg: 25, cd: 1.25, range: "uzak", description: "Kartopu rakibi 1.2sn dondurur." },
  ...
  { id: "dev-sinek", name: "Dev Sinek", emoji: "🪰", rarity: "common", hp: 350, dmg: 20, cd: 2.0, range: "hava", description: "Havadan giden tank." },
