...
export const CARDS: CardDef[] = [
  ...
  { id: "hayalet", name: "Hayalet", emoji: "👻", rarity: "legendary", hp: 150, dmg: 45, cd: 1.0, range: "yakın", description: "Sadece 3x3 alanda görünür. Özellik: 5sn görünmez, hasarsız ve 2x hasar verir.", ability: "5 sn görünmezlik, hasarsızlık ve 2x hasar" },
