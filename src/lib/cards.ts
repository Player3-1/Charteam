...
export const CARDS: CardDef[] = [
  ...
  { id: "dev", name: "Dev", emoji: "🗿", rarity: "common", hp: 500, dmg: 30, cd: 1.8, range: "yakın", description: "Tankı yüksek, ön cephe birliği.", stoneCost: 6 },
  { id: "atli", name: "Atlı", emoji: "🐎", rarity: "rare", hp: 175, dmg: "25 / 75", cd: 1.2, range: "yakın", description: "Hızla çarparsa 75 hasar, yavaşken 25.", stoneCost: 4 },
  { id: "okcu", name: "Okçu", emoji: "🏹", rarity: "common", hp: 65, dmg: 25, cd: 0.5, range: "uzak", description: "Uzak menzilden hızlı oklar atar.", stoneCost: 3 },
  ...
  { id: "sapanci", name: "Sapancı", emoji: "🪨", rarity: "rare", hp: 70, dmg: 40, cd: 2.5, range: "uzak", description: "Aşırı uzun menzilden çarpan alan hasarı atar.", stoneCost: 4 },
  { id: "topcu", name: "Topçu", emoji: "💣", rarity: "rare", hp: 90, dmg: 75, cd: 2.5, range: "uzak", description: "Yıkıcı geniş alan hasarlı top ateşi.", stoneCost: 5 },
  ...
  { id: "kus-ordusu", name: "Kuş Ordusu", emoji: "🐦", rarity: "epic", hp: 20, dmg: 4.5, cd: 1.0, range: "hava", description: "5 hızlı kuş, gözden kaçırma.", stoneCost: 5 },
  ...
  { id: "madenci", name: "Madenci", emoji: "⛏️", rarity: "legendary", hp: 120, dmg: 30, cd: 0.9, range: "yakın", description: "İstenen yere kazıp çıkar.", ability: "Konum seç ve çık", stoneCost: 3 },
  { id: "doktor", name: "Doktor", emoji: "⚕️", rarity: "legendary", hp: 90, dmg: 0, cd: 0, range: "yakın", description: "Müttefiklere +90 can verir, canı azalan müttefikleri takip eder.", ability: "5 saniye CD ile 5x5 iyileştirme", stoneCost: 3 },
  { id: "bira-varili", name: "Bira Varili", emoji: "🍺", rarity: "legendary", hp: 1, dmg: 0, cd: 0, range: "yakın", description: "Müttefik hasarı 2.0x. 30sn dayanır.", ability: "10sn 3.0x hasar", stoneCost: 4 },
  { id: "bombalama-ucagi", name: "Bombalama Uçağı", emoji: "✈️", rarity: "legendary", hp: 80, dmg: 45, cd: 3.6, range: "hava", description: "3.6sn'de bir 4x4 alana 30 hasar.", ability: "6x6 alana 50 hasar süper bomba", stoneCost: 6 },
  { id: "zirhli", name: "Zırhlı", emoji: "🛡️", rarity: "epic", hp: 300, dmg: 40, cd: 1.5, range: "yakın", description: "Tank. 8sn savunma duruşu hasarın %25'ini emer.", ability: "8sn savunma", stoneCost: 5 },
  ...
  { id: "balik", name: "Balık", emoji: "🐟", rarity: "epic", hp: 125, dmg: 30, cd: 2.0, range: "yakın", description: "Saldırıp geri kaçar sürekli.", stoneCost: 1 },
  ...
  { id: "cig", name: "Çığ", emoji: "🏔️", rarity: "epic", hp: 0, dmg: 100, cd: 5.0, range: "uzak", description: "Belirlenen yere atılır ve yeteneği kullanıldığında düştüğü yerin 5 blok ötesine kadar uzanan bir alana 100 hasar verir.", stoneCost: 3 },
