...
export const CARDS: CardDef[] = [
  { id: "mizrakli", name: "Mızraklı", emoji: "🔱", rarity: "common", hp: 160, dmg: 80, cd: 1.4, range: "uzak", description: "Orta menzilli, 80 hasar veren mızraklı bir savaşçı.", stoneCost: 5 },
  ...
  { id: "dev", name: "Dev", emoji: "🗿", rarity: "common", hp: 500, dmg: 30, cd: 1.8, range: "yakın", description: "Yüksek cana sahip ön saf tankı.", stoneCost: 6 },
  { id: "atli", name: "Süvari", emoji: "🐎", rarity: "rare", hp: 175, dmg: "40 / 90", cd: 1.4, range: "yakın", description: "Hızlı hücumda 90, yavaşken 40 hasar vurur.", stoneCost: 4 },
  ...
  { id: "kus-ordusu", name: "Kuş Ordusu", emoji: "🐦", rarity: "epic", hp: 20, dmg: 10, cd: 1.5, range: "hava", description: "Yakalanamayan 5 hızlı kuş birimi.", stoneCost: 5 },
  ...
  { id: "madenci", name: "Madenci", emoji: "⛏️", rarity: "legendary", hp: 175, dmg: 30, cd: 1.4, range: "yakın", description: "İstenen konuma kazarak ilerler ve aniden ortaya çıkar.", ability: "İstenen konumda kazıp ortaya çıkma", stoneCost: 3 },
  { id: "doktor", name: "Doktor", emoji: "⚕️", rarity: "legendary", hp: 125, dmg: 30, cd: 1.4, range: "yakın", description: "Dost birimleri +120 Can iyileştirir, düşük canlıları takip eder ve rakiplere vurabilir.", ability: "5 saniye bekleme süreli 5x5 alan iyileştirmesi", stoneCost: 3 },
  ...
  { id: "bombalama-ucagi", name: "Bombardıman Uçağı", emoji: "✈️", rarity: "legendary", hp: 100, dmg: 60, cd: 3.6, range: "hava", description: "Her 3.6 saniyede bir 4x4 alana 60 hasar bırakır.", ability: "6x6 alana 50 hasar veren süper bomba", stoneCost: 4 },
  ...
  { id: "kurbaga", name: "Kurbağa", emoji: "🐸", rarity: "legendary", hp: 90, dmg: 30, cd: 2.0, range: "uzak", description: "Diliyle saldırarak rakibi 10 saniye boyunca zehirler (saniyede 3 hasar).", ability: "En yakın kartı yutar, 2 saniye sonra patlar.", stoneCost: 3 },
  ...
  { id: "balik", name: "Dev Balık", emoji: "🐟", rarity: "epic", hp: 600, dmg: 40, cd: 2.0, range: "yakın", description: "Her rakip kart elendiğinde kendi canını 100 HP yeniler.", stoneCost: 7 },
  { id: "mercan", name: "Mercan", emoji: "🪸", rarity: "epic", hp: 50, dmg: 0, cd: 2.0, range: "yakın", description: "Her 2 saniyede bir tüm ekibi 10 Can iyileştirir.", ability: "Tüm ekibe 75 Can verir.", stoneCost: 4 },
  { id: "lav-kopegi", name: "Lav Köpeği", emoji: "🐕", rarity: "legendary", hp: 400, dmg: 45, cd: 1.5, range: "yakın", description: "Isırığı yakar (7 saniye boyunca saniyede 5 hasar). Saldırıda 3x3 alana alev üfler.", ability: "3 saniye boyunca 3x3 alana saniyede 20 hasar verir.", stoneCost: 5 },
  ...
  { id: "kabile", name: "Kabile", emoji: "👺", rarity: "common", hp: 25, dmg: 25, cd: 1.0, range: "yakın", description: "Arena 9'da açılan, 25 can ve hasarlı temel birim.", stoneCost: 1 },
  ...
  { id: "samuray", name: "Samuray", emoji: "🥷", rarity: "legendary", hp: 200, dmg: 90, cd: 1.4, range: "yakın", description: "Arena 11'de açılan efsanevi savaşçı. Yetenek: darbesi 2 kat hasar verir.", ability: "Darbesi 2 kat hasar verir (toplam 180)", stoneCost: 5 },
  ...
  { id: "uc-basli-ejder", name: "Üç Başlı Ejder", emoji: "🦎", rarity: "rare", hp: 333, dmg: 231, cd: 1.6, range: "hava", description: "Üç ayrı başıyla farklı hasarlar ve dondurma/yakma efektleri uygular.", ability: "Normal, donduran ve yakıcı saldırılar", stoneCost: 7 },
  { id: "vampir", name: "Vampir", emoji: "🧛", rarity: "legendary", hp: 320, dmg: 45, cd: 1.5, range: "yakın", description: "Her vurduğunda maksimum canı 50 artar (en fazla 500) ve kendisine 45 can verir. Yetenek: Canını full yapar. Yetenek maliyeti: 1", ability: "Canını tamamen yeniler (Maliyet: 1)", stoneCost: 5 },
  { id: "zombi", name: "Zombi", emoji: "🧟", rarity: "common", hp: 777, dmg: 44, cd: 1.6, range: "yakın", description: "Yüksek dayanıklılığa sahip, her vurduğunda kendi canını 44 dolduran zombi.", ability: "Her vuruşta canı 44 doldurur", stoneCost: 8 },
  ...
  { id: "lanet", name: "Lanet", emoji: "🖤", rarity: "epic", hp: 1, dmg: 0, cd: 1.0, range: "uzak", description: "Yetenek: Bedava. Tek kullanımlıktır, kullanınca yok olur. Tüm rakipleri 4.4 saniyeliğine dondurur (hareket edemez ve vuramazlar).", ability: "Tüm rakipleri 4.4 saniyeliğine dondurur (Kendini yok eder)", stoneCost: 4 }
];
