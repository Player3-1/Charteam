...
export const CARDS: CardDef[] = [
  ...
  { id: "kilicli", name: "Kılıç Ustası", emoji: "⚔️", rarity: "common", hp: 200, dmg: 90, cd: 1.5, range: "yakın", description: "Yavaş ama sert vuran usta kılıç dövüşçüsü.", stoneCost: 3 },
  { id: "dev", name: "Dev", emoji: "🗿", rarity: "common", hp: 600, dmg: 30, cd: 1.8, range: "yakın", description: "Yüksek cana sahip ön saf tankı.", stoneCost: 5 },
  ...
  { id: "okcu", name: "Okçu", emoji: "🏹", rarity: "common", hp: 65, dmg: 25, cd: 0.4, range: "uzak", description: "Uzun menzilden seri ok fırlatır.", stoneCost: 3 },
  { id: "tufekci", name: "Tüfekçi", emoji: "🔫", rarity: "rare", hp: 105, dmg: 20, cd: 1.6, range: "uzak", description: "Öne doğru yay biçiminde 4 mermi püskürten nişancı.", stoneCost: 4 },
  ...
  { id: "doktor", name: "Doktor", emoji: "⚕️", rarity: "legendary", hp: 100, dmg: 30, cd: 1.4, range: "yakın", description: "Dost birimleri +250 Can iyileştirir (Maks 3 kullanım, bedava).", ability: "5x5 alanda +250 can (Bedava, maks 3 kullanım)", stoneCost: 3 },
  ...
  { id: "bombalama-ucagi", name: "Bombardıman Uçağı", emoji: "✈️", rarity: "legendary", hp: 100, dmg: 50, cd: 1.4, range: "hava", description: "Her 1.4 saniyede bir 4x4 alana 50 hasar bırakır.", ability: "6x6 alana 50 hasar veren süper bomba", stoneCost: 4 },
  ...
  { id: "kopek-baligi", name: "Köpek Balığı", emoji: "🦈", rarity: "rare", hp: 400, dmg: 60, cd: 1.3, range: "yakın", description: "Çok hızlı ve dayanıklı yakın dövüş birimi.", stoneCost: 4 },
  ...
  { id: "lav-kopegi", name: "Lav Köpeği", emoji: "🐕", rarity: "legendary", hp: 500, dmg: 45, cd: 1.1, range: "yakın", description: "Isırığı yakar (7 saniye boyunca saniyede 5 hasar). Saldırıda 3x3 alana alev üfler.", ability: "3 saniye boyunca 3x3 alana saniyede 20 hasar verir.", stoneCost: 5 },
  ...
  { id: "kabile", name: "Kabile", emoji: "👺", rarity: "common", hp: 100, dmg: 50, cd: 1.0, range: "yakın", description: "Arena 9'da açılan, 5 savaşçıdan oluşan 100 can ve 50 hasarlı kabile birimleri (Alan hasarından 6 vuruşta ölür).", stoneCost: 5 },
  ...
  { id: "samuray", name: "Samuray", emoji: "🥷", rarity: "legendary", hp: 200, dmg: 10, cd: 0.2, range: "yakın", description: "Hem yakın menzilde kılıçla hem uzak menzilde shuriken ile 10 hasar verir.", ability: "Yakın ve uzak saldırı", stoneCost: 4 },
  { id: "buz-ejderi", name: "Buz Ejderi", emoji: "❄️", rarity: "epic", hp: 110, dmg: 40, cd: 1.5, range: "hava", description: "Saldırıları düşmanı yavaşlatır.", ability: "Vuruşunda yavaşlatma etkisi", stoneCost: 3 },
  { id: "uc-basli-ejder", name: "Üç Başlı Ejder", emoji: "🦎", rarity: "rare", hp: 175, dmg: 111, cd: 1.6, range: "hava", description: "Üç ayrı başıyla hasarlar (%20 azaltılmış) ve dondurma/yakma efektleri uygular.", ability: "Normal, donduran ve yakıcı saldırılar (-20% hasar)", stoneCost: 7 },
  { id: "vampir", name: "Vampir", emoji: "🧛", rarity: "legendary", hp: 145, dmg: 30, cd: 1.5, range: "uzak", description: "Vurduğu hasar başına tüm kartların canı 30 dolar. Yetenek: 4 saniye görünmez olur.", ability: "4 saniye görünmezlik", stoneCost: 4 },
  { id: "zombi", name: "Mezarlık", emoji: "🪦", rarity: "common", hp: 100, dmg: 0, cd: 5.0, range: "yakın", description: "Olduğu yerde kalarak her 5 saniyede bir 150 can / 30 hasarlı zombi spawnlar.", ability: "5 saniyede bir zombi spawnlar", stoneCost: 4 },
  ...
  { id: "lanet", name: "Lanet", emoji: "🖤", rarity: "epic", hp: 1, dmg: 0, cd: 1.0, range: "uzak", description: "Yetenek: 5 Taş. Tek kullanımlıktır, kullanınca yok olur. Tüm rakipleri 3 saniyeliğine dondurur.", ability: "Tüm rakipleri 3 saniyeliğine dondurur", stoneCost: 5 }
];
